...
export function Health() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-semibold text-zinc-900 dark:text-zinc-100 mb-4">Health</h1>
      <div className="space-y-4">
        <div className="rounded-lg border border-zinc-200 dark:border-zinc-800 p-4">
          <h2 className="font-medium text-zinc-900 dark:text-zinc-100 mb-2">Ready (DB check)</h2>
          {ready.isLoading && <p className="text-zinc-500">Loading…</p>}
        ...
        <div className="rounded-lg border border-zinc-200 dark:border-zinc-800 p-4">
          <h2 className="font-medium text-zinc-900 dark:text-zinc-100 mb-2">Live</h2>
          {live.isLoading && <p className="text-zinc-500">Loading…</p>}
