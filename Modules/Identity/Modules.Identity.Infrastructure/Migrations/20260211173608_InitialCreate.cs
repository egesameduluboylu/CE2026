        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValueTR = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_I18nResources", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApiCallsPerMinute = table.Column<int>(type: "int", nullable: false),
                    WebhooksCount = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTfaTokens", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserTfaTokenId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_UserTfaTokens_UserTfaTokenId",
                        column: x => x.UserTfaTokenId,
                        principalTable: "UserTfaTokens",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "RateLimitQuotas",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EndpointKey = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PermitLimit = table.Column<long>(type: "bigint", nullable: false),
                    WindowSeconds = table.Column<long>(type: "bigint", nullable: false),
                    Burst = table.Column<long>(type: "bigint", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RateLimitQuotas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RateLimitQuotas_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RateLimitQuotas_Users_UserId1",
                        column: x => x.UserId1,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UsedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    UsedIpAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UsedUserAgent = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserBackupCodes_Users_UserId1",
                        column: x => x.UserId1,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserLoginHistories_Users_UserId1",
                        column: x => x.UserId1,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RateLimitQuotas_TenantId",
                table: "RateLimitQuotas",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_RateLimitQuotas_UserId1",
                table: "RateLimitQuotas",
                column: "UserId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBackupCodes_UserId1",
                table: "UserBackupCodes",
                column: "UserId1");

            migrationBuilder.CreateIndex(
                name: "IX_UserLoginHistories_UserId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_UserTfaTokenId",
                table: "Users",
                column: "UserTfaTokenId",
                unique: true,
                filter: "[UserTfaTokenId] IS NOT NULL");
