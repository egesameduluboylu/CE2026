...
{
    public static ObjectResult BadRequest(string detail = "Bad Request")
    ...
    public static ObjectResult FromResultError(ResultError error, string? traceId = null)
    {
        var status = error.HttpStatus ?? StatusCodes.Status400BadRequest;
